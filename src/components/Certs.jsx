    ...
    <section id="certs" className="py-24 px-[5%] bg-transparent">
      <div ref={ref} className="max-w-[900px] mx-auto reveal">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-white/[0.07] backdrop-blur-xl border border-white/[0.10] rounded-2xl p-5 shadow-glass transition-all duration-300 hover:bg-white/[0.12] hover:-translate-y-1">
            <div className="text-[11px] font-bold tracking-[1px] uppercase text-white/40 mb-2">
              Coursera / Dicoding
            </div>
            <div className="font-display text-sm font-bold text-white mb-1 leading-[1.3]">
              Machine Learning Fundamentals
            </div>
            <div className="text-xs text-white/40">2024</div>
